This is a simple web app that creates and configures servers in AWS.  For it to work, you'll need first rename the .env.example file to .env.  Add AWS private and public keys.
...
It's a very simple application, and in the interest of time, didn't spend much time on design. Clicking 'New Server' will let you create a new server.  You'll need to add a name and select
